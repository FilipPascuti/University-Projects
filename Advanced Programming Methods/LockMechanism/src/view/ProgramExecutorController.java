...
import model.utilities.DTOs.LockTableEntry;
...
public class ProgramExecutorController {
    ...
    @FXML
    private TableColumn<LockTableEntry,String> lockTableLocation;
    @FXML
    private TableColumn<LockTableEntry,String> lockTableValue;
    ...
    public void initialize(){
        ...
        lockTableLocation.setCellValueFactory(new PropertyValueFactory<>("location"));
    ...
    private void populateWidgets() {
        ...
        try {
            ...
            populateLockTableView(currentProgram);
    ...
    private void populateLockTableView(ProgramState currentProgram) {
        ILockTable<Integer, Integer> lockTable = currentProgram.getLockTable();
        ArrayList<LockTableEntry> entries = new ArrayList<>();
        for(Map.Entry<Integer, Integer> entry : lockTable.getContent().entrySet()){
            entries.add(new LockTableEntry(entry.getKey().toString(), entry.getValue().toString()));
        }
