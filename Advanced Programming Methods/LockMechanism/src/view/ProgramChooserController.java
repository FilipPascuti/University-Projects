    ...
    private ObservableList<Controller> getControllerList() {
        ...
        while(iterator.hasNext()){
            try{
                ...
                ProgramState state = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new FileTable(), statement, new MyHeap<>(), new LockTable<>());
                                                            ...
                                                            new CompoundStatement(
                                                                    new ForkStatement(new CompoundStatement(
                                                                            new ForkStatement(new CompoundStatement(
                                                                                    new LockStatement("x"),
                                                                                    new CompoundStatement(
                                                                                            new HeapWriteStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VarExpression("v1")), new ValueExpression(new IntValue(1)),2 )),
                                                                            ...
                                                                            new CompoundStatement(
                                                                                    new ForkStatement(new CompoundStatement(
                                                                                            new ForkStatement(new CompoundStatement(
                                                                                                    new LockStatement("q"),
                                                                                                    new CompoundStatement(
                                                                                                            new HeapWriteStatement("v2", new ArithmeticExpression(new ReadHeapExpression(new VarExpression("v2")), new ValueExpression(new IntValue(5)),1 )),
