...
public class ProgramState {
    ...
    public ProgramState(IStack<IStatement> executionStack, IDictionary<String, Value> symbolTable, IList<Value> output, IFileTable fileTable, IStatement originalProgram, IHeap<Value> heap, LockTable<Integer,Integer> lockTable) {
    ...
    public void setLockTable(LockTable<Integer,Integer> lockTable) {
        this.lockTable = lockTable;
    }
