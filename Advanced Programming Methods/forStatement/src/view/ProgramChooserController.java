                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                new ForStatement(
                                        ...
                                        new ValueExpression(new IntValue(3)),
                                        new ArithmeticExpression(new VarExpression("v"), new ValueExpression(new IntValue(1)), 1),
                                        new ForkStatement(new CompoundStatement(
                                                new PrintStatement(new VarExpression("v")),
                                                new AssignmentStatement("v", new ArithmeticExpression(new ReadHeapExpression(new VarExpression("a")),new VarExpression("v"), 3)))
                                        )),
                                new PrintStatement(new ReadHeapExpression(new VarExpression("a")))
                        )
                )
