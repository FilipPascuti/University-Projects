    ...
    private IList<IStatement> getStatementsList() {
        ...
        IStatement statement12 = new CompoundStatement(
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                new ForStatement(
                                        new CompoundStatement(new VariableDeclarationStatement("v", new IntType()), new AssignmentStatement("v", new ValueExpression(new IntValue(0)))),
                                        ...
                                        new ForkStatement(new CompoundStatement(
                                                new PrintStatement(new VarExpression("v")),
                                                new AssignmentStatement("v", new ArithmeticExpression(new VarExpression("v"), new ReadHeapExpression(new VarExpression("a")), 3))
                                                ))
                                        ),
                                new PrintStatement(new ReadHeapExpression(new VarExpression("a")))
                        )
