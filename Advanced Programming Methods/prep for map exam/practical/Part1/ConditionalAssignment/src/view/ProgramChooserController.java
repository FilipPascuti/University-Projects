                                        ...
                                        new CompoundStatement(
                                                ...
                                                new CompoundStatement(
                                                        ...
                                                        new CompoundStatement(
                                                                ...
                                                                new CompoundStatement(
                                                                        new ConditionalAssignmentStatement("v",new RelationalExpression(new ReadHeapExpression(new VarExpression("a")), new ReadHeapExpression(new VarExpression("b")), "<"), new ValueExpression(new IntValue(100)), new ValueExpression(new IntValue(200))),
                                                                        new CompoundStatement(
                                                                                new PrintStatement(new VarExpression("v")),
                                                                                new CompoundStatement(
                                                                                        new ConditionalAssignmentStatement("v", new RelationalExpression(new ArithmeticExpression(new ReadHeapExpression(new VarExpression("b")), new ValueExpression(new IntValue(2)), 2), new ReadHeapExpression(new VarExpression("a")), ">"),  new ValueExpression(new IntValue(100)), new ValueExpression(new IntValue(200))),
                                                                                        new PrintStatement(new VarExpression("v"))
                                                                                )
                                                                        )
                                                                )
