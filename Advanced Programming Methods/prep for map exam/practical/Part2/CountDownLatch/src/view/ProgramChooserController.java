    ...
    private ObservableList<Controller> getControllerList() {
        ...
        while(iterator.hasNext()){
            try{
                ...
                ProgramState state = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new FileTable(), statement, new MyHeap<>(), new LatchTable<>());
                                                ...
                                                new CompoundStatement(
                                                        ...
                                                        new CompoundStatement(
                                                                ...
                                                                new CompoundStatement(
                                                                        ...
                                                                        new CompoundStatement(
                                                                                new ForkStatement(new HeapWriteStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VarExpression("v1")),new ValueExpression(new IntValue(10)), 3))),
                                                                                new CompoundStatement(
                                                                                        new PrintStatement(new ReadHeapExpression(new VarExpression("v1"))),
                                                                                        new CompoundStatement(
                                                                                                new CountDownStatement("cnt"),
                                                                                                new CompoundStatement(
                                                                                                        new ForkStatement(new HeapWriteStatement("v2", new ArithmeticExpression(new ReadHeapExpression(new VarExpression("v2")), new ValueExpression(new IntValue(10)),3) )),
                                                                                                        new CompoundStatement(
                                                                                                                new PrintStatement(new ReadHeapExpression(new VarExpression("v2"))),
                                                                                                                new CompoundStatement(
                                                                                                                        new CountDownStatement("cnt"),
                                                                                                                        new CompoundStatement(
                                                                                                                                new ForkStatement(new HeapWriteStatement("v3", new ArithmeticExpression(new ReadHeapExpression(new VarExpression("v3")), new ValueExpression(new IntValue(10)),3))),
                                                                                                                                new CompoundStatement(
