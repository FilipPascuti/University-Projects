...
import model.utilities.DTOs.LatchTableEntry;
...
public class ProgramExecutorController {
    ...
    @FXML
    private TableView<LatchTableEntry> latchTableView;
    @FXML
    private TableColumn<LatchTableEntry, String> latchTableLocation;
    @FXML
    private TableColumn<LatchTableEntry, String> latchTableValue;
    ...
    public void initialize(){
        ...
        latchTableLocation.setCellValueFactory(new PropertyValueFactory<>("location"));
        latchTableValue.setCellValueFactory(new PropertyValueFactory<>("value"));
    ...
    private void populateWidgets() {
        ...
        try {
            ...
            populateLatchTableView(currentProgram);
    ...
    private void populateLatchTableView(ProgramState currentProgram) {
        ILatchTable<Integer, Integer> latchTable = currentProgram.getLatchTable();
        ArrayList<LatchTableEntry> entries = new ArrayList<>();
        for(Map.Entry<Integer, Integer> entry : latchTable.getContent().entrySet()){
            entries.add(new LatchTableEntry(entry.getKey().toString(), entry.getValue().toString()));
        }
        latchTableView.setItems(FXCollections.observableArrayList(entries));
    }
