    ...
    private ObservableList<Controller> getControllerList() {
        ...
        while(iterator.hasNext()){
            try{
                ...
                ProgramState state = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new FileTable(), statement, new MyHeap<>(), new SemaphoreTable<>());
                                                ...
                                                new CompoundStatement(
                                                        ...
                                                        new CompoundStatement(
                                                                ...
                                                                new CompoundStatement(
                                                                        ...
                                                                        new CompoundStatement(
                                                                                new HeapWriteStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VarExpression("v1")), new ValueExpression(new IntValue(2)),3 )),
                                                                                new CompoundStatement(
                                                                                        new PrintStatement(new ReadHeapExpression(new VarExpression("v1"))),
                                                                                        new CompoundStatement(
                                                                                                new ReleaseStatement("cnt"),
                                                                                                new CompoundStatement(
                                                                                                        new AcquireStatement("cnt"),
                                                                                                        new CompoundStatement(
                                                                                                                new PrintStatement(new ArithmeticExpression(new ReadHeapExpression(new VarExpression("v1")), new ValueExpression(new IntValue(1)),2 )),
                                                                                                                new ReleaseStatement("cnt")
                                                                                                        )
                                                                                                )
                                                                                        )
