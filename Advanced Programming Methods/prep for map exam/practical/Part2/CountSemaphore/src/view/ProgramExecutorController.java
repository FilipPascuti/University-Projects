...
import model.utilities.DTOs.SemaphoreTableEntry;
...
public class ProgramExecutorController {
    ...
    @FXML
    private TableColumn<SemaphoreTableEntry, String> semaphoreTableIndex;
    @FXML
    private TableColumn<SemaphoreTableEntry, String> semaphoreTableValue;
    @FXML
    private TableColumn<SemaphoreTableEntry, String> semaphoreTableList;
    ...
    public void initialize(){
        ...
        semaphoreTableIndex.setCellValueFactory(new PropertyValueFactory<>("index"));
        semaphoreTableValue.setCellValueFactory(new PropertyValueFactory<>("value"));
        semaphoreTableList.setCellValueFactory(new PropertyValueFactory<>("list"));
    ...
    private void populateWidgets() {
        ...
        try {
            ...
            populateSemaphoreTableView(currentProgram);
    ...
    private void populateSemaphoreTableView(ProgramState currentProgram) {
        ISemaphoreTable<Integer, Pair<Integer,List<Integer>>> semaphoreTable = currentProgram.getSemaphoreTable();
        ArrayList<SemaphoreTableEntry> entries = new ArrayList<>();
        for(Map.Entry<Integer, Pair<Integer,List<Integer>>> entry : semaphoreTable.getContent().entrySet()){
            entries.add(new SemaphoreTableEntry(entry.getKey().toString(), entry.getValue().getKey().toString(),entry.getValue().getValue().toString()));
        }
        semaphoreTableView.setItems(FXCollections.observableArrayList(entries));
    }
